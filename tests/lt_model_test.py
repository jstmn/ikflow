...
class LitModelTest(unittest.TestCase):
    ...
    def test_gradient_calculated(self):
        ...
        zero_response0 = self.ik_solver.generate_ik_solutions([0] * 7, n=5, latent=fixed_latent)
        ...
        loss.backward()
        optimizer.step()
        zero_response_f = self.ik_solver.generate_ik_solutions([0] * 7, n=5, latent=fixed_latent)
