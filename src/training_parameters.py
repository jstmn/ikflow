...
class cINN_SoftflowParameters(Config):
    def __init__(self):
        ...
        self.rnvp_clamp = 2.5
        self.y_noise_scale = 1e-7  # When directly regressing a 1-hot vector, we need some noise
        self.zeros_noise_scale = 1e-3  # Also add noise to the padding for robustness

        self.softflow_noise_scale = 0.01
        self.softflow_enabled = True

        Config.__init__(self, "cINN_SoftflowParameters")
