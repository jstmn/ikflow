...
from src.training_parameters import MDNParameters, MultiCINN_Parameters, cINN_SoftflowParameters, TrainingConfig
...
def check_cinn_sflow_parameters(params: cINN_SoftflowParameters):
    """Asserts that cinn_softflow parameters are valid"""
...
# Initialize models
def initialize_glow_model(params_trainable, hyper_parameters: cINN_SoftflowParameters):
...
def train(
    model_wrapper: ModelWrapper,
    training_config: TrainingConfig,
    hyper_parameters: Union[cINN_SoftflowParameters, MDNParameters],
